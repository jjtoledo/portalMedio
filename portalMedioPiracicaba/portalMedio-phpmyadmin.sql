...
--
-- Host: localhost
-- Generation Time: 30-Ago-2016 às 10:04
...
(1, 'JoÃ£o Monlevade', ''),
(2, 'Rio Piracicaba', ''),
(3, 'AlvinÃ³polis', 'tes tes tes tes tes teste tetet tse tet steset stes tseknvfkaomdkands'),
(4, 'BarÃ£o de Cocais', 'tes tes tes tes tes teste tetet tse tet steset stes tseknvfkaomdkands'),
(5, 'Bela Vista de Minas', 'tes tes tes tes tes teste tetet tse tet steset stes tseknvfkaomdkands'),
(6, 'Catas Altas', 'tes tes tes tes tes teste tetet tse tet steset stes tseknvfkaomdkands'),
(7, 'DionÃ­sio', 'tes tes tes tes tes teste tetet tse tet steset stes tseknvfkaomdkands'),
(8, 'Dom SilvÃ©rio', 'tes tes tes tes tes teste tetet tse tet steset stes tseknvfkaomdkands'),
(9, 'GuanhÃ£es', 'tes tes tes tes tes teste tetet tse tet steset stes tseknvfkaomdkands'),
(10, 'Itabira', 'tes tes tes tes tes teste tetet tse tet steset stes tseknvfkaomdkands'),
(11, 'Nova Era', 'tes tes tes tes tes teste tetet tse tet steset stes tseknvfkaomdkands');
...
--
-- Estrutura da tabela `foto_camaras`
--

CREATE TABLE `foto_camaras` (
  `id` int(11) NOT NULL,
  `foto` varchar(255) DEFAULT NULL,
  `descricao` text DEFAULT NULL,
...
--
-- Estrutura da tabela `foto_prefeitos`
--

CREATE TABLE `foto_prefeitos` (
  `id` int(11) NOT NULL,
  `foto` varchar(255) DEFAULT NULL,
...
ALTER TABLE `camaras`
  ADD PRIMARY KEY (`id`,`cidade_id`),
  ADD KEY `fk_camaras_cidades1_idx` (`cidade_id`);

--
-- Indexes for table `foto_camaras`
--
ALTER TABLE `foto_camaras`
  ADD PRIMARY KEY (`id`,`camara_id`),
  ADD KEY `fk_fotocamaras_camaras1_idx` (`camara_id`);
...
--
-- Indexes for table `foto_prefeitos`
--
ALTER TABLE `foto_prefeitos`
...
ALTER TABLE `denominacaos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
  --
-- AUTO_INCREMENT for table `camaras`
--
ALTER TABLE `camaras`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `foto_camaras`
--
ALTER TABLE `foto_camaras`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `foto_orgaos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `foto_prefeitos`
--
ALTER TABLE `foto_prefeitos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `camaras`
  ADD CONSTRAINT `fk_camras_cidades1` FOREIGN KEY (`cidade_id`) REFERENCES `cidades` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Limitadores para a tabela `foto_camaras`
--
ALTER TABLE `foto_camaras`
  ADD CONSTRAINT `fk_foto_camaras_camara1` FOREIGN KEY (`camara_id`) REFERENCES `camaras` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Limitadores para a tabela `foto_prefeitos`
--
ALTER TABLE `foto_prefeitos`
