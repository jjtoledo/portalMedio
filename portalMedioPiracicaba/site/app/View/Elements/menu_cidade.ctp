<?php 
	...
	if ($active == 'transporte') {
		echo $this->Html->link('<span class="glyphicon glyphicon-plus-sign"></span> ' . 'Horários de Ônibus', array('action' => 'site_transporte', $id), array('class' => 'listMenu active', 'escape' => false));
	} else {
		echo $this->Html->link('<span class="glyphicon glyphicon-plus-sign"></span> ' . 'Horários de Ônibus', array('action' => 'site_transporte', $id), array('class' => 'listMenu', 'escape' => false));
	}
	echo '</div>';
