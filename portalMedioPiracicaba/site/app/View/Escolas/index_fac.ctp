...
<div class="container escolas index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h2><?php echo __('Faculdades de ' . $cidade['Cidade']['nome']); ?></h2>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
					...
					<div class="panel-heading"><?php echo __('Ações'); ?></div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								...
								<li><?php echo $this->Html->link('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;'.__('Nova faculdade'), array('action' => 'add', $cidade['Cidade']['id'], 3), array('escape' => false)); ?></li>
							</ul>
						</div><!-- end body -->
				</div><!-- end panel -->
			</div><!-- end actions -->
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<?php foreach ($escolas as $escola): ?>
					<tr>
						<td nowrap><?php echo h($escola['Escola']['nome']); ?>&nbsp;</td>
						<td nowrap><?php echo h($escola['Escola']['telefone1']); ?>&nbsp;</td>
