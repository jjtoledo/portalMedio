...
<div class="container fotos form">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h2><?php echo __('Adicionar Ex Presidentes da Câmara'); ?></h2>
			</div>
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="col-md-9">
			<?php echo $this->Form->create('PresidenteCamara', array('type' => 'file')); ?>

				<div class="form-group">
					<?php echo $this->Form->input('fotos.', array('type' => 'file', 'multiple', 'label' => 'Ex Presidentes', 'required' => 'true'));?>
				</div>
				<div class="form-group">
