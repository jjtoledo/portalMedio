...
<div class="container fotos form">
	...
	<div class="row">
				...
				<div class="panel panel-default">
					<div class="panel-heading"><?php echo __('Ações'); ?></div>
						<div class="panel-body">
							...
							<li><?php echo $this->Html->link('<span class="glyphicon glyphicon-menu-left"></span>&nbsp;&nbsp;'.__('Voltar'), array('action' => 'index', $espaco['EspacoEvento']['id']), array('escape' => false)); ?> </li>
							</ul>
						</div>
					</div>
				</div>			
		...
		<div class="col-md-9">
			<?php echo $this->Form->create('FotoEspaco', array('type' => 'file')); ?>
