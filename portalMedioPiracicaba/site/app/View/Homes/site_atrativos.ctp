	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
	  ...
	  <div class="carousel-inner resolucao" role="listbox">
  		...
  		if (!empty($fotos_aereas)) {
	      	...
	      	if (isset($cidade)) {	      		
	    			echo 		'<h1 class="welcome">Confira os atrativos turísticos de '.$cidade['Cidade']['nome'].'</h1>';
	      	} else {
	      		echo 		'<h1 class="welcome">Confira os atrativos turísticos da região Médio Piracicaba</h1>';
	      	}
