 ...
 */
class FotoCamara extends AppModel {
 ...
 */
	...
	public function beforeSave($options = array()) {
		//debug($this->data);
		if(!empty($this->data['FotoCamara']['foto']['name'])) {
	        $this->data['FotoCamara']['foto'] = $this->upload($this->data['FotoCamara']['foto']);
	    } else {
	        unset($this->data['FotoCamara']['foto']);
	    }
	}
