 ...
 */
class FotoEscola extends AppModel {
 ...
 */
	...
	public function beforeSave($options = array()) {
		//debug($this->data);
		if(!empty($this->data['FotoEscola']['foto']['name'])) {
	        $this->data['FotoEscola']['foto'] = $this->upload($this->data['FotoEscola']['foto']);
	    } else {
	        unset($this->data['FotoEscola']['foto']);
	    }
	}
