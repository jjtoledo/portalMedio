 ...
 */
class Eleicao extends AppModel {
 ...
 */
	...
	public function beforeSave($options = array()) {
		//debug($this->data);
		if(!empty($this->data['Eleicao']['excel']['name'])) {
	        $this->data['Eleicao']['excel'] = $this->upload($this->data['Eleicao']['excel']);
	    } else {
	        unset($this->data['Eleicao']['excel']);
	    }
	}
