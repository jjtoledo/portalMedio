 ...
 */
	...
	public function beforeSave($options = array()) {
		//debug($this->data);
		if(!empty($this->data['Documento']['foto_anuncio']['name'])) {
	        $this->data['Documento']['foto_anuncio'] = $this->upload($this->data['Documento']['foto_anuncio']);
	    } else {
	        unset($this->data['Documento']['foto_anuncio']);
	    }
	}
