 ...
 * @property Rio $Rio
 */
class FotoRio extends AppModel {
 ...
 */
	...
	public function beforeSave($options = array()) {
		//debug($this->data);
		if(!empty($this->data['FotoRio']['foto']['name'])) {
	        $this->data['FotoRio']['foto'] = $this->upload($this->data['FotoRio']['foto']);
	    } else {
	        unset($this->data['FotoRio']['foto']);
	    }
	}
