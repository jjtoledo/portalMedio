 ...
 */
class FotoSaude extends AppModel {
 ...
 */
	...
	public function beforeSave($options = array()) {
		//debug($this->data);
		if(!empty($this->data['FotoSaude']['foto']['name'])) {
	        $this->data['FotoSaude']['foto'] = $this->upload($this->data['FotoSaude']['foto']);
	    } else {
	        unset($this->data['FotoSaude']['foto']);
	    }
	}
