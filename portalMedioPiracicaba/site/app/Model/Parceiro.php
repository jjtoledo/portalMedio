...
class Parceiro extends AppModel {
	...
	{
		debug($this->data['Parceiro']['foto']);
	    if(!empty($this->data['Parceiro']['foto']['name'])) {
	        $this->data['Parceiro']['foto'] = $this->upload($this->data['Parceiro']['foto']);
	    } else {
	        unset($this->data['Parceiro']['foto']);
	    }
	}
